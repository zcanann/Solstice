...
local function LoadNavMesh()
    ...
    print(PRINT_PREFIX .. "LoadNavMesh (v" .. dataVersion .. ") Completed After: " .. CoreMath.Round(totalTimer:End(), 2) .. "s")
...
local function PostProcessNavMesh()
    ...
    print(string.format("%sPostProcessNavMesh Completed After: %0.1fs, culled tiles = %i, tiles left = %i", PRINT_PREFIX, CoreMath.Round(totalTimer:End(), 2), cullCount, navMesh.numTiles))
...
local function CalculateNavMesh()
    ...
    print(string.format("%sCalculateNavMesh Completed After: %0.1fs", PRINT_PREFIX, CoreMath.Round(totalTimer:End(), 2)))
...
local function PostProcessNavGrid()
    ...
    generationData.info.culledTiles = generationData.info.culledTiles + cullCount
    print(string.format("%sPostProcessNavGrid Completed After: %0.1fs, culled tiles = %i, tiles left = %i", PRINT_PREFIX, CoreMath.Round(totalTimer:End(), 2), cullCount, generationData.navGrid.numTiles))
...
local function CalculateNavGrid()
    ...
    print(string.format("%sCalculateNavGrid Completed After: %0.1fs, generated tiles = %i", PRINT_PREFIX, CoreMath.Round(totalTimer:End(), 2), generationData.navGrid.numTiles))
