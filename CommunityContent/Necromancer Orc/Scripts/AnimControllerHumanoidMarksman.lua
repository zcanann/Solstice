--[[
	Animation Controller - Humanoid Marksman
	v1.0
...
local IDLE_STANCE = script:GetCustomProperty("IdleStance") or "1hand_melee_idle_relaxed"
...
function PlayAttack()
	MESH:PlayAnimation("unarmed_magic_bolt", {playbackRate = 0.6})
