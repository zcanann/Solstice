...
Events.Connect(Framework.Events.Input.EVENT_TOGGLE_SPELLBOOK_TAB, function () SetActiveTab(propTabSpellbook) end)
...
Events.Connect(Framework.Events.Input.EVENT_TOGGLE_QUESTS_TAB, function () SetActiveTab(propTabQuests) end)
Events.Connect(Framework.Events.Input.EVENT_TOGGLE_OPTIONS_TAB, function () SetActiveTab(propTabOptions) end)
