...
Framework.Events.Connect(Framework.Events.Keys.Input.EVENT_TOGGLE_COMBAT_TAB, function () SetActiveTab(propTabCombat) end)
Framework.Events.Connect(Framework.Events.Keys.Input.EVENT_TOGGLE_EQUIPMENT_TAB, function () SetActiveTab(propTabEquipment) end)
Framework.Events.Connect(Framework.Events.Keys.Input.EVENT_TOGGLE_SOUL_TAB, function () SetActiveTab(propTabSoul) end)
Framework.Events.Connect(Framework.Events.Keys.Input.EVENT_TOGGLE_SPELLBOOK_TAB, function () SetActiveTab(propTabSpellbook) end)
Framework.Events.Connect(Framework.Events.Keys.Input.EVENT_TOGGLE_INVENTORY_TAB, function () SetActiveTab(propTabInventory) end)

Framework.Events.Connect(Framework.Events.Keys.Input.EVENT_TOGGLE_SKILLS_TAB, function () SetActiveTab(propTabSkills) end)
Framework.Events.Connect(Framework.Events.Keys.Input.EVENT_TOGGLE_QUESTS_TAB, function () SetActiveTab(propTabQuests) end)
Framework.Events.Connect(Framework.Events.Keys.Input.EVENT_TOGGLE_OPTIONS_TAB, function () SetActiveTab(propTabOptions) end)
