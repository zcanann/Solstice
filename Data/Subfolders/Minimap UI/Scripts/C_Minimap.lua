...
- Some additional effort may be required if you intend to support mouse interaction. For example:
	...
	c) Broadcast a custom 'mouse down event', passing in the mouse position, and a bool for left/right click.
	d) The minimap will set _G.uiHitTest to true if it detects a click, and broadcast a custom 'move to location event' with a Vector3
